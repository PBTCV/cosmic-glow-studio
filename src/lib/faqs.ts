export const homeFaqs = [
  ...
  },
  {
    ...
    answer:
      "Founders, executives, and families seeking clarity on career moves, wealth timing, relationships, property decisions, and major life transitions benefit from structured Vedic counsel.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Browse the Council section on the homepage to compare astrologer profiles, specialties, and languages, then book a consultation directly from their profile page.",
  },
] as const;
